      ...
      >
        ...
        <Modal opened={opened} onClose={close} centered size={"lg"}>
          ...
          >
            ...
            <Text size="lg" color="dimmed" className={classes.description}>
              The search results will display code snippets that are most
              relevant to the user's query, ranked by their similarity to the
              input text. Users can view and compare the retrieved code snippets
              to find the one that best suits their needs. This approach to code
              search aims to improve the efficiency and accuracy of finding
              relevant code by leveraging advanced natural language processing
